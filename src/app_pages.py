...
dbc.Row(
    dbc.Col(
        dbc.FormFloating([
            dbc.Input(type="username", placeholder="kullanıcı adı", id='user_tr'),
...
dbc.Row(
    dbc.Col(
        dbc.FormFloating([
            dbc.Input(type="password", placeholder="şifre", id='passw_tr'),
            dbc.Label("Şifre")
                ],), width=2
            #    style={"margin": "auto", 'width': '28.125rem', 'height': '2.813rem', 'padding': '0.625rem',
            #           'margin-top': '4.375rem', 'font-size': '1rem', 'border-width': '0.188rem'}
...
dbc.Row(
    dbc.Col(
        submit_button_tr , width=4, style={'text-align':'center'}
    ), align='center', justify='center'
)]
...
dbc.Row(
    html.H3('Tendering Process', style={'color':'white', 'outline-color':'white', 'margin':'auto', 'text-align':'center'}),
    justify='center', align='center'
),
...
dbc.Row(
    dbc.Col(
        dbc.FormFloating([
            dbc.Input(type="username", placeholder="username", id='user_eng'),
            dbc.Label("Username")
                ],), width=2
            #    style={"margin": "auto", 'width': '28.125rem', 'height': '2.813rem', 'padding': '0.625rem',
            #           'margin-top': '4.375rem', 'font-size': '1rem', 'border-width': '0.188rem'}
...
dbc.Row(
    dbc.Col(
        dbc.FormFloating([
            dbc.Input(type="password", placeholder="password", id='passw_eng'),
            dbc.Label("Password")
                ],), width=2
            #    style={"margin": "auto", 'width': '28.125rem', 'height': '2.813rem', 'padding': '0.625rem',
            #           'margin-top': '4.375rem', 'font-size': '1rem', 'border-width': '0.188rem'}
...
dbc.Row(
    dbc.Col(
        submit_button_eng , width=4, style={'text-align':'center'}
    ), align='center', justify='center'
)]
...
def login_page():
    ...
    return  html.Div(id='main', children=[
         dbc.Tabs([
            dbc.Tab(login_page_tr, label="TR", tab_id='tr', activeTabClassName="fw-bold fst-italic", tab_style={"marginLeft": "auto"}, active_label_style={'backgroundColor':'transparent'}),
            dbc.Tab(login_page_eng, label="ENG", tab_id='eng', activeTabClassName="fw-bold fst-italic", tab_style={}, active_label_style={'backgroundColor':'transparent'}),
    ], id = 'login_tabs')
        ],
        ...
        layout = html.Div([
                ...
                dbc.Container([
                    ...
                    dbc.Row(children=[
                            ...
                            dbc.Col(
                                dbc.Alert(id='display-selected-package', children='Varsayılan cihaz listesini görebilmek için lütfen kategori-paket seçimi yapınız.', color="primary"),
                                style={'color':'white'}
                        ...
                        cihaz_row('Gateway', lang='tr'),
                        cihaz_row('Trifaz Analizör', lang='tr'),
                        cihaz_row('Akım Trafosu', lang='tr'),
                        cihaz_row('Sıcaklık Sensörü', lang='tr'),
                        cihaz_row('Su Sayacı', lang='tr'),
                        cihaz_row('Akıllı Klima Kontrol', lang='tr'),

                        cihaz_row('Modbus Converter', lang='tr'),
                        cihaz_row('Güç Kaynağı', lang='tr'),
                        cihaz_row('Jeneratör Kartı', lang='tr'),
                        cihaz_row('Monofaz Analizör', lang='tr'),
                        cihaz_row('Pulse Okuyucu', lang='tr'),
                        cihaz_row('UPS', lang='tr'),

                        html.Br(),

                        dbc.Row(children=[

                                dbc.Col(myButton(lang='tr'), width=2, align='center'), 
        ...
        layout = html.Div([
                ...
                dbc.Container([
                    ...
                    dbc.Row([
                        ...
                        dbc.Col([
                            dbc.Alert([
                                html.Div([html.H5("Dollar Rate", style={'color':'#44d9e8','font-weight':'bold'}) , html.Label(f"{tcmb_data()}₺")],
                                )
                            ] , color='dark' )
                        ] , style={'color':'white','font-weight':'bold','width':'33.3%','text-align':'center'}, width=1 ),
                        ...
                        dbc.Col([
                            dbc.Alert([
                                html.Div([html.H5("Euro Rate", style={'color':'#44d9e8','font-weight':'bold'}) , html.Label(f"{tcmb_data('EUR')}₺")],
                                )
                            ] , color='dark' )
                        ] , style={'color':'white','font-weight':'bold','width':'33.3%','text-align':'center'}, width=1 ),
                        ...
                        dbc.Col([
                            dbc.Alert([
                                html.Div([html.H5("Sterling Rate", style={'color':'#44d9e8','font-weight':'bold'}) , html.Label(f"{tcmb_data('GBP')}₺")],
                                )
                            ] , color='dark' )
                        ] , style={'color':'white','font-weight':'bold','width':'33.3%','text-align':'center'}, width=1 ),
                    ...
                    dbc.Row(children=[
                        ...
                        dbc.Col(
                            html.Label('Project Name', style=input_style) , align='center', width=1
                        ),
                        ...
                        dbc.Col(
                            html.Label("Customer Name" , style=input_style), align='center', width=1
                        ),
                        ...
                        dbc.Col(
                            html.Label("Offer Prepared By" , style=input_style), align='center', width=2
                        ),
                    ...
                    dbc.Row(children=[
                        ...
                        dbc.Col(
                            html.Label('Category', style=input_style) , align='center', width=1
                        ),
                        ...
                        dbc.Col(
                            html.Label("Package" , style=input_style), align='center', width={'size':1,'offset':1}
                        ),
                    ...
                    dbc.Row(children=[
                        ...
                        dbc.Col(
                            html.Label('Inter-city Number', style=input_style) , align='center', width=1
                        ),
                        ...
                        dbc.Col(
                            html.Label('Intra-city Number', style=input_style) , align='center', width={'size':1,'offset':1}
                        ),
                    ...
                    dbc.Row(children=[
                            ...
                            dbc.Col(
                                dbc.Alert(id='display-selected-package', children='Please select a category-package combination in order to view default device list.', color="primary"),
                                style={'color':'white'}
                        ...
                        cihaz_row('Gateway', lang='eng'),
                        cihaz_row('Three-Phase Analyzer', lang='eng'),
                        cihaz_row('Current Transformer', lang='eng'),
                        cihaz_row('Heat Sensor', lang='eng'),
                        cihaz_row('Water Meter', lang='eng'),
                        cihaz_row('Smart AC Control Unit', lang='eng'),

                        cihaz_row('Modbus Converter', lang='eng'),
                        cihaz_row('Power Source', lang='eng'),
                        cihaz_row('Generator Board', lang='eng'),
                        cihaz_row('Monophase Analyzer', lang='eng'),
                        cihaz_row('Pulse Reader', lang='eng'),
                        cihaz_row('UPS', lang='eng'),

                        html.Br(),

                        dbc.Row(children=[

                                dbc.Col(myButton(lang='eng'), width=2, align='center'),
        ...
        return ( html.Div([
            ...
            dbc.Container([
                ...
                dbc.Row([
                    ...
                    dbc.Col( [dbc.Button(html.Img(src="/assets/download.svg"), download='FiyatListesi.xlsx', href='/static/FiyatListesi.xlsx', external_link=True, color='transparent', size='lg', outline=False, style={'color':'#ea39b8'}), dbc.Button('Download Price File', download='FiyatListesi.xlsx', href='/static/FiyatListesi.xlsx', external_link=True, color='transparent', size='lg', outline=False, style={'color':'#ea39b8'})],  width=6 ),

                    dbc.Col( [dbc.Button(html.Img(src="/assets/download.svg"), download='Packages.xlsx', href='/static/Packages.xlsx', external_link=True, color='transparent', size='lg', outline=False, style={'color':'#ea39b8'}), dbc.Button('Download Package File', download='Packages.xlsx', href='/static/Packages.xlsx', external_link=True, color='transparent', size='lg', outline=False, style={'color':'#ea39b8'})],  width=6 ),
            ...
            dbc.Row(children=[
                ...
                dbc.Col( dbc.Button( id='fiyat_button', children='Price Table', n_clicks=0, outline=True, color='transparent', size='lg', style={'text-align':'start'}), style={'color':'#6f42c1', 'margin-left':'0px'}, width=3),
                dbc.Col( dbc.Popover('Click To Save Price Table !', target="fiyat_button", body=True, trigger="hover", hide_arrow=True, style={'backgroundColor':'transparent', 'border': '0.2px solid', 'outline-color':'#1ba2f6'}) ),
                dbc.Col( html.Div(id='fiyat_dummy'), width=1 ),
                dbc.Col( dbc.Popover('Click For Default Price Table !', target="fiyat_reset_button", body=True, trigger="hover", hide_arrow=True, placement='left', style={'backgroundColor':'transparent', 'border': '0.2px solid', 'outline-color':'#1ba2f6'}) ),
                dbc.Col( dbc.Button( id='fiyat_reset_button', children='Default', n_clicks=0, outline=False, color='transparent', size='lg', style={'color':'#ea39b8'} ), style={'color':'#ea39b8','text-align':'right'}, width={'offset':0} ),
            ...
            dbc.Row(children=[
                ...
                dbc.Col( dbc.Button( id='paket_button', children='Package Table', n_clicks=0, outline=False, color='Info', size='lg', style={'text-align':'start'} ), style={'color':'#6f42c1','margin-left':'0px'} ),
                dbc.Col( dbc.Popover('Click To Save Package Table !', target="paket_button", body=True, trigger="hover", hide_arrow=True, style={'backgroundColor':'transparent', 'border': '0.2px solid', 'outline-color':'#1ba2f6'}) ),
                dbc.Col( html.Div(id='paket_dummy'), width=1 ),
                dbc.Col( dbc.Popover('Click For Default Package Table !', target="paket_reset_button", body=True, trigger="hover", hide_arrow=True, placement='left', style={'backgroundColor':'transparent', 'border': '0.2px solid', 'outline-color':'#1ba2f6'}, ) ),
                dbc.Col( dbc.Button( id='paket_reset_button', children='Default', n_clicks=0, outline=False, color='transparent', size='lg', style={'color':'#ea39b8'} ), style={'color':'#ea39b8','text-align':'right'}, width={'offset':0} ),
